<?php
	...
	class chaosChatDAO extends commonDAO{
		private $insertQuery = "
			INSERT INTO chaos_chat(chat_user) VALUES(:chat_user)
		";

		private $selectQuery = "
			SELECT * FROM chaos_chat
		";
		private $chk_selectQuery = "
			SELECT * FROM chaos_chat WHERE chat_user=:chat_user
		";
		private $cnt_selectQuery = "
			SELECT COUNT(*) FROM chaos_chat
		";

		private $deleteQuery = "
			DELETE FROM chaos_chat WHERE chat_user=:chat_user
		";
